...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "Residential Construction",
    description: "Nestled in the high-alpine region of Montana, this 8,500 sq ft luxury ranch was brought to life over 24 months. The emergence of modern mountain architecture with rustic charm, using exposed timber and custom stone masonry to complement the panoramic landscape. The residence features high volume 22-foot vaulted ceilings and floor-to-ceiling windows that dissolve the boundary between the interior and the breathtaking mountain views. Radiant floor heating, a gourmet kitchen with natural stone countertops, and custom millwork throughout ensure that comfort and elegance are felt in every corner. This home was designed and a new standard to maximize all efficiencies, custom forced air system to maintain special comfort in every corner.",
  ...
  // RESIDENTIAL CONSTRUCTION
  {
    ...
    additionalInfo: "Montana",
    category: "Residential Construction",
    description: "In just eight months, this new 2,800 sq ft condo was completed as a new build sophisticated mountain retreat. The new build focused on creating a sanctuary of modern comfort, featuring spa-inspired bathrooms with heated floors and contemporary finishes throughout. The selections were of a palette of Calacatta marble, warm walnut, and refined brass fixtures to evoke a sense of understated luxury. The result is a space that perfectly balances modern living with the tranquility of a mountain setting. Along with warm wood accents, and special hand-applied wall/ceiling finishes. Fine marbles, many of which were installed as full slabs for floor to ceiling wall finishes.",
    image: montanaCover,
  ...
  // HOSPITALITY
  {
    ...
    description: "We orchestrated the creation of a 189,000 gallon ultra-luxury private club amenity, a project that demanded the coordination of over 15 specialty trades. The centerpiece is a beautiful free-form pool with a swim-up bar, complemented by a 1,200 sq ft pool house. The Int. design, inspired by 1950s New York smoking clubs, features imported travertine and custom stonework. This 18-month project delivered a resort-style oasis with professional landscaping, fire pits, and an outdoor kitchen, setting a new standard for private club luxury. And 10' high solid mahogany wood walls and doors.",
  ...
  // RESIDENTIAL CONSTRUCTION
  {
    ...
    roles: "ALL HOME PROJECT, ESTATE BARN + STORAGE ROUNDED OUT",
  },
  {
