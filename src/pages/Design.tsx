      ...
      <section className="relative pt-32 pb-16 sm:pt-40 sm:pb-20 md:pt-48 md:pb-24 bg-gradient-to-br from-charcoal via-charcoal/95 to-charcoal/90">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="max-w-7xl mx-auto">
            {/* Back Button */}
            <Button variant="ghost" onClick={() => navigate("/")} className="mb-8 text-cream hover:text-gold transition-colors group">
            ...
            <div className="text-center mb-8 sm:mb-12">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-playfair font-bold mb-4 sm:mb-6 text-cream tracking-tight leading-tight">Design</h1>
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 max-w-5xl mx-auto">
              {["Interiors", "Architecture", "Development", "Concepts", "Pools", "Custom Furniture"].map(category => <span key={category} className="px-4 py-2 bg-cream/10 backdrop-blur-sm border border-cream/20 rounded-full text-cream text-sm font-inter font-light hover:bg-cream/20 transition-colors cursor-default">
                  {category}
                </span>)}
            </div>
          </div>
