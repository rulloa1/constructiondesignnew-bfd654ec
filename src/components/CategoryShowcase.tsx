...
export const CategoryShowcase: React.FC<CategoryShowcaseProps> = ({ onViewProjects }) => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-3xl mb-16 opacity-0 animate-fade-in">
          ...
          <p className="font-inter text-lg text-muted-foreground font-light leading-relaxed">
            Specializing in three distinct categories of design and construction excellence, 
            each project is tailored to meet the unique vision and requirements of our clients.
          </p>
        </div>
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                <div className="transform transition-transform duration-500 group-hover:-translate-y-2">
                  ...
                  <Button
                    onClick={() => onViewProjects(category.title)}
                    variant="outline"
